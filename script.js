...
document.getElementById("popup-close").addEventListener("click", function(){
  ...
  document.querySelectorAll(".product")[0].addEventListener("click", function(){
    ...
    document.getElementById("price-product").innerHTML = "R$ 145,00";
    document.getElementById("price-custom").innerHTML = "R$ 25,00";
    document.getElementById("price-shipping").innerHTML = "R$ 0,00";
